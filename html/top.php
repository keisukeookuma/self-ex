    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <a class="nav-link signup" href="#">新規登録</a>
          </li>
          <li class="nav-item">
            <a class="nav-link login" href="#">ログイン</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <section>
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-6">
          <div class="p-5">
            <img class="img-fluid" src="./img/8e2aa33c46096d0502b68cb056c5b5cf1f430a4e.png" alt="">
          </div>
        </div>
        <div class="col-lg-6">
          <div class="p-5 font-20">
...
<script>
    $('.signup').click(function(){
        alert('現在新規登録機能は整備中です。いつかきっとできるはずです。');
    });
    $('.login').click(function(){
        alert('現在ログイン機能は整備中です。欲しい機能があれば教えて下さい。')
    })
</script>
