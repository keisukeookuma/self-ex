...
<div class="container-fluid noprint">
    <div class="row pt-5">
        <nav-side class="col-md-1 d-none d-md-block pt-2 px-0">
        ...
        <div class="col-md-4 pt-2 px-4 border overflow-auto">
            ...
            <!-- <div class="overflow-auto" style="width:100%; height: 662vh;"> -->
                <div class="container a">
                    <div class="tab-content p-3 d-flex justify-content-center">
                        <div id="preview" class="tab-pane fade show active m-0 p-4">
                            <h1 class="m-1 text-center" contentEditable="true">リハビリメニュー</h1>
                        </div>
                    </div>
                </div>
            </div>
